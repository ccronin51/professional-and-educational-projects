...
def compute_hedge_long(contract_pounds,number_contracts,tzero_spot_price,tzero_futures_price,tone_spot_price,tone_futures_price):
    ...
    return futures_gain_position_long,net_cost_long,net_cost_locked_in_if_converged_long, cost_long
#%%
...
metal_delta.columns = ['sentiment_hrc']
...
result2.index = mi2
result2.columns = ['futures_gain_position_long','net_cost_long','net_cost_locked_in_if_converged_long','cost_long']
...
for col in ['futures_gain_position_long','net_cost_long','net_cost_locked_in_if_converged_long']:
    result2[col] = np.where(result2['sentiment_bush'] < 0, 0, result2[col])
#%% 
''' Long Separate Plots '''      
...
#%% 
col_list = ['futures_gain_position_long','net_cost_long','net_cost_locked_in_if_converged_long','cost_long]
